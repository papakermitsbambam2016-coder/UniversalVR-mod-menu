...
namespace ChainsawBONELABCodeMod
{
    public class Main : MelonMod
    {
        ...
        public override void OnInitializeMelon()
        {
            ...
            MelonLogger.Msg("Runtime scanner is waiting for Chainsaw objects.");
        }
        ...
        public override void OnUpdate()
        {
            ...
            if (active)
            {
                for (int i = blades.Count - 1; i >= 0; i--)
                {
                    ...
                    // Visual/runtime blade motion. Direction and speed can be tuned after Quest testing.
        ...
        private void ScanForChainsaws()
        {
            ...
            try
            {
                ...
                {
                    active = true;
                    MelonLogger.Msg($"Found {blades.Count} possible Chainsaw/blade transform(s).");
                }
            }
            catch (Exception e)
            {
